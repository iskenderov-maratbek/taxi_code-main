...
class PhoneNumberRestore extends StatefulWidget {
  const PhoneNumberRestore({super.key});

  @override
  State<PhoneNumberRestore> createState() => _PhoneNumberRestoreState();
}

class _PhoneNumberRestoreState extends State<PhoneNumberRestore> {
          ...
          onPressed: () async {
            if (formKey.currentState!.validate()) {
              if (await showPinCodeDialog(context) && mounted) {
                ...
                Navigator.pushNamed(context, '/new_password_restore');
              }
            }
          },
          child: const Text(
